...
import (
	...
	"github.com/SevenTV/GQL/src/api/v3/resolvers/emoteset"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/mutation"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/query"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/report"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/role"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/subscription"
	"github.com/SevenTV/GQL/src/api/v3/resolvers/user"
	user_editor "github.com/SevenTV/GQL/src/api/v3/resolvers/user-editor"
	user_emote "github.com/SevenTV/GQL/src/api/v3/resolvers/user-emote"
